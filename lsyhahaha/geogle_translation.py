...
#     url = 'https://translate.google.cn/?sl={}&tl=zh-CN&text={}&op=translate'.format('en','zh-CN',text)
#
...
class TranslateByGoogle():
    ...
    def translate(self, key_words, language_to="en", language_from="auto"):
        ...
        if language_to in ("en", "de"):
            n = 10
        self.__data["f.req"] = '[[["MkEWBc","[[\\"{}\\",\\"{}\\",\\"{}\\",true],[null]]",null,"generic"]]]'.format(
            key_words, language_from, language_to)
...
if __name__ == "__main__":
    ...
    # print("苗语： {}".format(tran.translate(str1, "hmn")))
    #
